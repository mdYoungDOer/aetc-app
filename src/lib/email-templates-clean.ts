...
<body>
    <div class="container">
        ...
        <div class="contact-info">
            ...
            <p><strong>Website:</strong> <a href="https://aetconference.com" style="color: #FBA91E;">aetconference.com</a></p>
        </div>

        <div style="text-align: center; margin: 30px 0;">
            <a href="https://aetconference.com/my-tickets" class="btn">View My Tickets</a>
            <a href="https://aetconference.com" class="btn">Conference Info</a>
        </div>

        <div class="footer">
            <p>Need assistance? Contact us at <a href="mailto:support@aetconference.com" style="color: #293972;">support@aetconference.com</a></p>
    ...
    <div class="container">
        ...
        <div class="instructions">
            ...
            <ol>
                ...
                <li>Visit <a href="https://aetconference.com/auth/verify-otp" style="color: #293972;">aetconference.com/auth/verify-otp</a></li>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="https://aetconference.com/auth/verify-otp" class="btn">Verify My Account</a>
            <a href="https://aetconference.com/my-tickets" class="btn">View My Tickets</a>
        </div>

        <div class="footer">
            <p>Need help? Contact us at <a href="mailto:support@aetconference.com" style="color: #293972;">support@aetconference.com</a></p>
            <p>© 2026 Africa Energy Technology Conference. All rights reserved.</p>
        </div>
    </div>
</body>
