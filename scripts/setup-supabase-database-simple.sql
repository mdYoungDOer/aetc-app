...
-- Insert super admin role for your user (check if exists first)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM public.user_roles WHERE user_id = '2df40b25-6fe1-4c1f-b327-1c1602a65698') THEN
